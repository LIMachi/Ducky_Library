package com.limachi.ducky_library.common.network;
...
import com.limachi.ducky_library.common.utils.LevelSavedGlobalNBT;
...
import static com.limachi.ducky_library.DuckyLib.MOD_ID;
...
public class PacketHandler {
    ...
    static {
        ...
        registerMsg(LevelSavedGlobalNBT.LevelSavedGlobalNBTSyncMsg.class);
    }
    ...
    public static <T extends Message> void toClients(T msg) {
        for (ServerPlayerEntity player : DuckyLib.getServer().getPlayerList().getPlayers())
            toClient(player, msg);
    }
