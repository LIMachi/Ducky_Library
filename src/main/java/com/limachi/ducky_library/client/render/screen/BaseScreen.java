package com.limachi.ducky_library.client.render.screen;

import com.limachi.ducky_library.client.render.widgets.BaseWidget;
...
public abstract class BaseScreen<T extends BaseContainer> extends ContainerScreen<T> {
    ...
    public BaseWidget getFocusedWidget() { return focusedWidget; }
    public void setFocusedWidget(BaseWidget widget) { focusedWidget = widget; }

    public void addWidget(BaseWidget widget) { widgets.add(widget); }
